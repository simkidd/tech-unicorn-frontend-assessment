  ...
  return (
    <Wrapper className="w-full h-full py-[4rem] pb-[5rem]">
      <div className="flex flex-col items-center gap-12 relative">
        <h2 className="font-[700] text-[48px]">What Our Customer Says</h2>
        <div className="container w-full flex justify-center items-center">
          ...
          >
            {TestimonialData.map((item, i) => {
              return (
                <SwiperSlide key={i}>
                  <div className="bg-[var(--color-10)] flex flex-col relative rounded-[8px] p-[5rem] pt-16 pb-8 items-center justify-center ">
