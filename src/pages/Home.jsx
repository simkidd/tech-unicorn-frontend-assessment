...
const Home = () => {
  return (
    <div className="w-full bg-white">
      ...
      <section>
        <div className="container w-full mx-auto px-[2rem] text-white">
          <div className="flex flex-col items-center justify-center bg-[var(--color-50)] p-[2rem] py-[3rem]">
            <h4 className="text-[24px] pt-[3rem]">March Discount</h4>
            <h2 className="text-[64px] font-700 pb-[2rem]">Up to 70% off</h2>
      ...
      <section >
        <div className="container mx-auto px-[2rem] py-[8rem]">
